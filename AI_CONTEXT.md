...
- общее: `type` (строка-тег компонента), `name`, `vendor` (**"Location, Vendor"** — в листе это две колонки, см. 3.1), `price` (строка вида `"$1,234"` или `"123 К"`/`"123 С"`), `recommended` (`"Yes"`/нет).
